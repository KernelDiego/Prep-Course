...
function mesesDelAño(array) {
  ...
  if (tresMeses.length < 3) return "No se encontraron los meses pedidos";
  return tresMeses;
...
function breakStatement(numero) {
  ...
  // El ejercicio pide que lo haga con break y asi lo hice,
  // pero yo lo haria de la siguiente manera sin el break,
  // ya que me parece mas optimo.
